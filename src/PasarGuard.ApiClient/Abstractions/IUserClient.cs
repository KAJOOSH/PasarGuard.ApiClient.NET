...
public interface IUserClient
{
    ...
    Task<ApiResult<UsersResponse>> GetUsersAsync(long? offset = null, long? limit = null, IReadOnlyList<long>? ids = null, IReadOnlyList<string>? username = null, IReadOnlyList<string>? usernames = null, IReadOnlyList<string>? admin = null, IReadOnlyList<long>? adminIds = null, IReadOnlyList<long>? group = null, string? search = null, JsonElement? status = null, string? sort = null, string? proxyId = null, JsonElement? dataLimitResetStrategy = null, long? dataLimitMin = null, long? dataLimitMax = null, DateTimeOffset? expireAfter = null, DateTimeOffset? expireBefore = null, DateTimeOffset? onlineAfter = null, DateTimeOffset? onlineBefore = null, bool online = false, bool noDataLimit = false, bool noExpire = false, bool loadSub = false, CancellationToken cancellationToken = default);
