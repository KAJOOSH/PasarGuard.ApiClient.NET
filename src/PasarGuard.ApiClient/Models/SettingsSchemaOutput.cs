...
public sealed partial record SettingsSchemaOutput
{
    ...
    public NotificationSettingsOutput? NotificationSettings { get; init; }

    [JsonPropertyName(@"notification_enable")]
    public NotificationEnable? NotificationEnable { get; init; }

    [JsonPropertyName(@"subscription")]
    public SubscriptionOutput? Subscription { get; init; }
