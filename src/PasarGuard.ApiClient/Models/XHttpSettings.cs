...
public sealed record XHttpSettings
{
    ...
    [JsonPropertyName("session_id_table")]
    public string? SessionIdTable { get; init; }

    [JsonPropertyName("session_id_length")]
    public string? SessionIdLength { get; init; }
    ...
    public string? UplinkChunkSize { get; init; }
    ...
    public XMuxSettings? Xmux { get; init; }
