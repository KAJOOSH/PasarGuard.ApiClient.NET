...
public sealed partial record CreateHost
{
    [JsonPropertyName(@"id")]
    ...
    public List<string>? Sni { get; init; }
    ...
    public List<ProxyHostALPN>? Alpn { get; init; }
    ...
    public TransportSettingsInput? TransportSettings { get; init; }

    [JsonPropertyName(@"mux_settings")]
    public MuxSettingsInput? MuxSettings { get; init; }
    ...
    public List<string>? VerifyPeerCertByName { get; init; }
