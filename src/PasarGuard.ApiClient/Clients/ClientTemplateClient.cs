...
public sealed class ClientTemplateClient : ApiClientBase, IClientTemplateClient
{
    ...
    public Task<ApiResult<ClientTemplateResponseList>> GetClientTemplatesAsync(ClientTemplateType? templateType = null, long? offset = null, long? limit = null, CancellationToken cancellationToken = default)
    {
    ...
    public Task<ApiResult<ClientTemplatesSimpleResponse>> GetClientTemplatesSimpleAsync(ClientTemplateType? templateType = null, long? offset = null, long? limit = null, string? search = null, string? sort = null, bool? all = false, CancellationToken cancellationToken = default)
    {
